...
create table depots (
  ...
  depot_sf text not null unique,
  depot_status_id integer references depot_statuses (depot_status_id),
  depot_category_id integer references depot_categories (depot_category_id),
  parent integer references depots (depot_id),
  date_sign date,
  date_pub date,
  date_start date,
  date_end date,
...
create table task_events (
  task_event_id bigint primary key generated by default as identity,
  task_id integer not null references tasks (task_id),
