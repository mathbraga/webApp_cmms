...
<p>
  Os papéis (roles) no banco de dados correspondem aos seguintes grupos de usuários:
</p>
<table>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <td>inspector</td>
      <td>Terceirizados que atuam na fiscalização</td>
    </tr>
    <tr>
      <td>employee</td>
      <td>Terceirizados que atuam no âmbito dos contratos de manutenção</td>
    </tr>
    <tr>
      <td>visitor</td>
